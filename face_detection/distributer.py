...
class ImageRead(MapObj):
	def __init__(self, dataset):
	super(ImageRead, self).__init__(dataset);
	self.base_case = 0;
...
class Master(object):
	"""This is the server"""
	def __init__(self, host = 'localhost', port = 50000, log_run = True, backlog = 5, buffer_size = 1024, dataset = range(100), min_thr = 1, obj = ImageRead):
