reset
set autoscale
set title "Face, Eyes, Ear Detection times for different number of Faces"
set xlabel "Faces"
set ylabel "Time(s)"
set terminal postscript eps color enhanced 'NimbusSanL-Regu' 14
set size 1,1
set output "../plot_outputs/fig_faces-V-time_feat-2.eps"
plot "../raw_data/output_faces-V-time_feat-2.txt" using 1:2 title col with linespoints, \
	"../raw_data/output_faces-V-time_feat-2.txt" using 1:3 title col with linespoints, \
	...
	"../raw_data/output_faces-V-time_feat-2.txt" using 1:7 title col with linespoints
